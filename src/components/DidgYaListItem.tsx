...
const DidgYaListItem = ({
    ...
    return (
        <div
            className="flex flex-row gap-4 pl-3 pr-1.5 py-1.5 bg-neutral-light dark:bg-neutral-dark items-center justify-between text-3xl flex-no-wrap max-w-md w-full text-white"
            key={id}
        >
            ...
            <div className="flex flex-row gap-2 items-center">
                <span
                    id="play-button"
                    className="hidden w-6 text-secondary-light dark:text-secondary-dark cursor-pointer hover:text-secondary-light/60 hover:dark:text-secondary-dark/60"
                >
                    <FontAwesomeIcon icon={faStop} />
                </span>
                <span
                    id="stop-button"
                    className="w-6 text-primary-light dark:text-primary-dark mr-3 cursor-pointer hover:text-primary-light/60 hover:dark:text-primary-dark/60"
                >
